...
?>
			<div class="centrado">
				<h2><?php echo $strings['GProfesores']; ?></h2>
			</div>
...
?>
						<th class="addnsearch">
							<a href='../Controller/PROFESOR_Controller.php?action=ADD'><img height="16" src="<?php echo $icons['add']; ?>"></a>
							<a href='../Controller/PROFESOR_Controller.php?action=SEARCH'><img height="16" src="<?php echo $icons['search']; ?>"></a>
						</th>
					</tr>
				</thead>
				<tbody>
...
?>
						<td class="buttons">
							<a href='../Controller/PROFESOR_Controller.php?action=EDIT&dni=<?php echo $fila['DNI']; ?>'>
								<img height="16" src="<?php echo $icons['edit']; ?>">
							</a>
							<a href='../Controller/PROFESOR_Controller.php?action=DELETE&dni=<?php echo $fila['DNI']; ?>'>
								<img height="16" src="<?php echo $icons['delete']; ?>">
							</a>
							<a href='../Controller/PROFESOR_Controller.php?action=SHOWCURRENT&dni=<?php echo $fila['DNI']; ?>'>
