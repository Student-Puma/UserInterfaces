...
?>
						<th class="addnsearch">
							<a href='../Controller/USUARIOS_Controller.php?action=ADD'><img height="16" src="<?php echo $icons['add']; ?>"></a>
							<a href='../Controller/USUARIOS_Controller.php?action=SEARCH'><img height="16" src="<?php echo $icons['search']; ?>"></a>
						</th>
					</tr>
				</thead>
				<tbody>
...
?>
						<td class="buttons">
							<a href='../Controller/USUARIOS_Controller.php?action=EDIT&login=<?php echo $fila['login']; ?>'>
								<img height="16" src="<?php echo $icons['edit']; ?>">
							</a>
							<a href='../Controller/USUARIOS_Controller.php?action=DELETE&login=<?php echo $fila['login']; ?>'>
								<img height="16" src="<?php echo $icons['delete']; ?>">
							</a>
							<a href='../Controller/USUARIOS_Controller.php?action=SHOWCURRENT&login=<?php echo $fila['login']; ?>'>
