		...
		<form name="Form" action="../Controller/ESPACIO_Controller.php" method="post" onsubmit="enableAll(this);">
			<ul class="form-style">
				...
				<li>
					...
					<input type="text" readonly class="campo-dividido" id="superficie" name="superficie" value="<?php echo $this->tupla['SUPERFICIEESPACIO']; ?>">
					<input type="text" readonly class="campo-dividido" id="numinventario" name="numinventario" value="<?php echo $this->tupla['NUMINVENTARIOESPACIO']; ?>">
				</li>
				<li>
				...
				<li>
					<input type="text" readonly class="campo-dividido" id="CODEspacio" name="CODEspacio" value="<?php echo $this->tupla['CODESPACIO']; ?>">
