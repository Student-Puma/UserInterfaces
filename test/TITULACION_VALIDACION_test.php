<?php
    ...
    function TITULACION_Validar()
    {
        ...
        $TITULACION_array_error['metodo'] = "comprobar_atributos";
        $TITULACION_array_error["error"] = "Dos o más valores incorrectos";
        $TITULACION_array_error["error_esperado"] = "false";
